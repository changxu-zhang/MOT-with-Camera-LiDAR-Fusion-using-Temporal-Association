...
def format_centerpoint(res_bevfusion):
    new_res = {}
    for sample_idx in tqdm(range(len(res_bevfusion))):
...
def main():
    ...
    res_bevfusion = pd.read_pickle('results/1st_with_first_three_of_swin_with_epoch_1.pkl')
    ...
    save_file = open('results/1st_with_first_three_of_swin_with_epoch_1.json', 'w')
