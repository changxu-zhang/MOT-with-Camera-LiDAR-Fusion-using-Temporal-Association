# copy-paste from CenterPoint https://github.com/tianweiy/CenterPoint/blob/master/tools/nusc_tracking/pub_tracker.py
import numpy as np
import copy
  ...
  def step_centertrack(self, results, time_lag):
    ...
    if len(tracks) > 0:  # NOT FIRST FRAME
      dist = (((tracks.reshape(1, -1, 2) - \
                dets.reshape(-1, 1, 2)) ** 2).sum(axis=2))  # N x M # L2 distance
