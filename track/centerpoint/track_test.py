...
def parse_args():
    ...
    parser.add_argument("--root", type=str, default="/data_from_host/shared/datasets/nuscenes/nuscenes_mini_with_prev_next") # nuscenes_mini_with_prev_next # nuscenes_full_with_prev_next_container_bevfusion_new
    parser.add_argument("--version", type=str, default='v1.0-mini') # v1.0-trainval
