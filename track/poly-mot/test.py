...
# import debugpy
# debugpy.listen(1111)
# print("Wait for Debugger for test.py")
...
parser.add_argument('--nusc_path', type=str, default='/data_from_host/shared/datasets/nuscenes/nuscenes_full_with_prev_next_container_bevfusion_new/')
parser.add_argument('--config_path', type=str, default='config/nusc_config.yaml')
parser.add_argument('--detection_path', type=str, default='data/detector/val/val_bevfusion_swint_encoder_low_velocity.json')
