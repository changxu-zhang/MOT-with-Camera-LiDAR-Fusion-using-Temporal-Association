...
def main():
    ...
    f = open('results/tracking_with_polymot_with_2nd_with_full_3_epoch.json') # 'results/tracking_full_2nd_3_epoch/tracking_result.json'
    res = json.load(f)
    ...
    # save in .pkl    
    with open('results/tracking_with_polymot_with_2nd_with_full_3_epoch.pkl', 'wb') as handle: # 'results/visualization_tracking_full_2nd_3_epoch/visualization_tracking_full_2nd_3_epoch.pkl'
